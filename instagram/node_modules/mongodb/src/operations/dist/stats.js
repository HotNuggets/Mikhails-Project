...
/** @internal */
var DbStatsOperation = /** @class */ (function (_super) {
    __extends(DbStatsOperation, _super);
    function DbStatsOperation(db, options) {
        var _this = _super.call(this, db, options) || this;
        _this.options = options;
        return _this;
    }
    Object.defineProperty(DbStatsOperation.prototype, "commandName", {
        get: function () {
            return 'dbStats';
        },
        enumerable: false,
    ...
    DbStatsOperation.prototype.execute = function (server, session) {
