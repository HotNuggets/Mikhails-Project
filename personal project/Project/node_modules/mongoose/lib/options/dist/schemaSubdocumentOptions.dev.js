...
function (_SchemaTypeOptions) {
  ...
  function SchemaSubdocumentOptions() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SchemaSubdocumentOptions).apply(this, arguments));
  }

  return SchemaSubdocumentOptions;
}(SchemaTypeOptions);
