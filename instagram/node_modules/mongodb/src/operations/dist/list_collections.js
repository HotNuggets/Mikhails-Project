...
/** @internal */
var ListCollectionsOperation = /** @class */ (function (_super) {
    __extends(ListCollectionsOperation, _super);
    ...
    Object.defineProperty(ListCollectionsOperation.prototype, "commandName", {
        get: function () {
    ...
    ListCollectionsOperation.prototype.execute = function (server, session) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.executeCommand.call(this, server, session, this.generateCommand(utils_1.maxWireVersion(server)), responses_1.CursorResponse)];
    ...
    ListCollectionsOperation.prototype.generateCommand = function (wireVersion) {
        var command = {
            listCollections: 1,
            filter: this.filter,
