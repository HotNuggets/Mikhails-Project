...
var parse_utf8_1 = require("../parse_utf8");
var latin_1 = require("./latin");
/** @internal */
...
exports.nodeJsByteUtils = {
    ...
    toUTF8: function (buffer, start, end, fatal) {
        var basicLatin = end - start <= 20 ? latin_1.tryReadBasicLatin(buffer, start, end) : null;
        if (basicLatin != null) {
            return basicLatin;
        }
        var string = exports.nodeJsByteUtils.toLocalBufferType(buffer).toString('utf8', start, end);
        if (fatal) {
            for (var i = 0; i < string.length; i++) {
                if (string.charCodeAt(i) === 0xfffd) {
                    parse_utf8_1.parseUtf8(buffer, start, end, true);
                    break;
                }
            }
        }
    ...
    encodeUTF8Into: function (buffer, source, byteOffset) {
        var latinBytesWritten = latin_1.tryWriteBasicLatin(buffer, source, byteOffset);
