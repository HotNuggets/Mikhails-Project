...
var CountOperation = /** @class */ (function (_super) {
    ...
    function CountOperation(namespace, filter, options) {
        var _this = _super.call(this, { s: { namespace: namespace } }, options) || this;
        _this.options = options;
        _this.collectionName = namespace.collection;
        _this.query = filter;
        return _this;
    }
    Object.defineProperty(CountOperation.prototype, "commandName", {
        get: function () {
            return 'count';
        },
        enumerable: false,
    ...
    CountOperation.prototype.execute = function (server, session) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result ? result.n : 0];
                }
            });
        });
    };
