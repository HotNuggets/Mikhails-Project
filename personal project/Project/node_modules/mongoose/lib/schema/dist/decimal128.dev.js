...
SchemaDecimal128._defaultCaster = function (v) {
...
SchemaDecimal128._checkRequired = function (v) {
...
SchemaDecimal128.prototype.checkRequired = function checkRequired(value, doc) {
  ...
  var _checkRequired = typeof this.constructor.checkRequired === 'function' ? this.constructor.checkRequired() : SchemaDecimal128.checkRequired();
...
SchemaDecimal128.prototype.$conditionalHandlers = _objectSpread({}, SchemaType.prototype.$conditionalHandlers, {
  $gt: handleSingle,
  $gte: handleSingle,
  $lt: handleSingle,
  $lte: handleSingle
