...
var Long = /** @class */ (function (_super) {
    ...
    function Long(lowOrValue, highOrUnsigned, unsigned) {
        if (lowOrValue === void 0) { lowOrValue = 0; }
        ...
        var res = typeof lowOrValue === 'string'
     ...
     * @returns The corresponding Long value
     */
    Long._fromString = function (str, unsigned, radix) {
        if (str.length === 0)
    ...
    Long.fromStringStrict = function (str, unsignedOrRadix, radix) {
        var unsigned = false;
        ...
        var cleanedStr = StringUtils.removeLeadingZerosAndExplicitPlus(str);
    ...
    Long.fromString = function (str, unsignedOrRadix, radix) {
        var unsigned = false;
        if (typeof unsignedOrRadix === 'number') {
            // For goog.math.long compatibility
            (radix = unsignedOrRadix), (unsignedOrRadix = false);
    ...
    Long.fromExtendedJSON = function (doc, options) {
        var _a = __assign({}, options), _b = _a.useBigInt64, useBigInt64 = _b === void 0 ? false : _b, _c = _a.relaxed, relaxed = _c === void 0 ? true : _c;
    ...
    Long.prototype.inspect = function (depth, options, inspect) {
        inspect !== null && inspect !== void 0 ? inspect : ;
        utils_1.defaultInspect;
        var longVal = inspect(this.toString(), options);
        var unsignedVal = this.unsigned ? ", " + inspect(this.unsigned, options) : '';
