...
var NAN_BUFFER = byte_utils_1.ByteUtils.fromNumberArray([
    0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
].reverse());
// Infinity value bits 32 bit values (due to lack of longs)
var INF_NEGATIVE_BUFFER = byte_utils_1.ByteUtils.fromNumberArray([
    0xf8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
].reverse());
var INF_POSITIVE_BUFFER = byte_utils_1.ByteUtils.fromNumberArray([
 ...
 * @category BSONType
 */
var Decimal128 = /** @class */ (function (_super) {
    __extends(Decimal128, _super);
    /**
    ...
    function Decimal128(bytes) {
        ...
        else if (bytes instanceof Uint8Array || utils_1.isUint8Array(bytes)) {
     ...
     * @param representation - a numeric string representation.
     */
    Decimal128.fromStringWithRounding = function (representation) {
        return Decimal128._fromString(representation, { allowRounding: true });
    };
    Decimal128._fromString = function (representation, options) {
        ...
        var buffer = byte_utils_1.ByteUtils.allocateUnsafe(16);
        index = 0;
    ...
    Decimal128.prototype.inspect = function (depth, options, inspect) {
        inspect !== null && inspect !== void 0 ? inspect : ;
        utils_1.defaultInspect;
        var d128string = inspect(this.toString(), options);
