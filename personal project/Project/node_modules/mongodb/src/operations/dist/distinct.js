 ...
 * @internal
 */
var DistinctOperation = /** @class */ (function (_super) {
    __extends(DistinctOperation, _super);
    /**
    ...
    Object.defineProperty(DistinctOperation.prototype, "commandName", {
        get: function () {
            return 'distinct';
        },
        enumerable: false,
    ...
    DistinctOperation.prototype.execute = function (server, session) {
        return __awaiter(this, void 0, Promise, function () {
            var coll, key, query, options, cmd, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.explain ? result : result.values];
                }
            });
        });
    };
