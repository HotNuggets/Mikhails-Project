...
SchemaObjectId._checkRequired = function (v) {
...
SchemaObjectId._defaultCaster = function (v) {
...
SchemaObjectId.prototype.checkRequired = function checkRequired(value, doc) {
  ...
  var _checkRequired = typeof this.constructor.checkRequired === 'function' ? this.constructor.checkRequired() : SchemaObjectId.checkRequired();
...
SchemaObjectId.prototype.$conditionalHandlers = _objectSpread({}, SchemaType.prototype.$conditionalHandlers, {
  $gt: handleSingle,
  $gte: handleSingle,
  $lt: handleSingle,
  $lte: handleSingle
