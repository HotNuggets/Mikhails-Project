...
function (_MongooseError) {
  ...
  function ParallelValidateError(doc) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ParallelValidateError).call(this, msg + doc._doc._id));
  }

  return ParallelValidateError;
}(MongooseError);
