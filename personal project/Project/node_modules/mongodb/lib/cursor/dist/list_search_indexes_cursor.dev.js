...
var aggregation_cursor_1 = require("./aggregation_cursor");
/** @public */


var ListSearchIndexesCursor =
/*#__PURE__*/
function (_aggregation_cursor_) {
  ...
  function ListSearchIndexesCursor(_ref, name) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ListSearchIndexesCursor).call(this, client, ns, pipeline, options));
  }

  return ListSearchIndexesCursor;
