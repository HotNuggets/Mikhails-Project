...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, fullname, username, image, user, existingUser, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                    _a = req.body, email = _a.email, password = _a.password, fullname = _a.fullname, username = _a.username;
                    image = '../../../public/images/defaultProfile.png';
                    user = new userModel_1.User({ email: email, password: password, fullname: fullname, username: username, image: image });
                ...
                case 2:
                    existingUser = _b.sent();
                    if (existingUser) {
                        return [2 /*return*/, res.status(400).send({ error: 'Username already exists' })];
                    }
