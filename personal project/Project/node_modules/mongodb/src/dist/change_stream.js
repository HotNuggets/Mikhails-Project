...
var ChangeStream = /** @class */ (function (_super) {
    ...
    ChangeStream.prototype._processErrorStreamMode = function (changeStreamError) {
        ...
        if (this[kClosed])
            return;
        if (this.cursor.id != null && error_1.isResumableError(changeStreamError, this.cursor.maxWireVersion)) {
            this._endStream();
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(this.cursor.id == null ||
                            !error_1.isResumableError(changeStreamError, this.cursor.maxWireVersion))) return [3 /*break*/, 5];
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.close()];
