...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, username, user, existingUser, defaultBoard, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                    _a = req.body, email = _a.email, password = _a.password, username = _a.username;
                    user = new userModel_1.User({ username: username, email: email, password: password });
                ...
                case 2:
                    ...
                    return [4 /*yield*/, defaultBoard.save()];
                case 3:
                    _b.sent();
                    res.status(200).send({ ok: true });
                    return [3 /*break*/, 5];
