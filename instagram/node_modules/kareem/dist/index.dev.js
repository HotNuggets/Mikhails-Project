...
Kareem.prototype.execPre = function (name, context, args, callback) {
  ...
  function next() {
    ...
    if (pre.isAsync) {
      var _args2 = [decorateNextFn(_next), decorateNextFn(function (error) {
        if (error) {
          if (done) {
            return;
          }
      ...
      callMiddlewareFunction(pre.fn, context, _args2, _args2[0]);
    } else if (pre.fn.length > 0) {
      var _args3 = [decorateNextFn(_next)];
      ...
      callMiddlewareFunction(pre.fn, context, _args3, _args3[0]);
    } else {
...
Kareem.prototype.createWrapperSync = function (name, fn) {
  ...
  return function syncWrapper() {
    ...
    var result = _this.execPostSync(name, this, [toReturn]);
