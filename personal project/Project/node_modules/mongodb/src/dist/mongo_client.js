...
var executor_1 = require("./operations/client_bulk_write/executor");
...
var MongoClient = /** @class */ (function (_super) {
     ...
     */
    MongoClient.prototype.bulkWrite = function (models, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new executor_1.ClientBulkWriteExecutor(this, models, utils_1.resolveOptions(this, options)).execute()];
                    case 1: 
