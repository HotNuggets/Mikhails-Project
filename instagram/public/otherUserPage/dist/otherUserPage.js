...
function displayOtherUserPosts() {
    return __awaiter(this, void 0, void 0, function () {
        var userId, postsResponse, postsData, postsContainer_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    userId = localStorage.getItem('otherUserId');
                    return [4 /*yield*/, fetch("/posts/profile/" + userId)];
                case 1:
                ...
                case 2:
                    ...
                    postsContainer_1 = document.getElementById("user-posts");
                    postsContainer_1.innerHTML = ""; // Clear any existing content
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error displaying user posts:', error_1);
                    return [3 /*break*/, 4];
