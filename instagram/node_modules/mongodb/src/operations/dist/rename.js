...
var RenameOperation = /** @class */ (function (_super) {
    ...
    function RenameOperation(collection, newName, override, options) {
    ...
    Object.defineProperty(RenameOperation.prototype, "commandName", {
        get: function () {
    ...
    RenameOperation.prototype.execute = function (server, session) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new collection_1.Collection(this.collection.s.db, this.newName, this.collection.s.options)];
                }
            });
        });
    };
