...
var DocumentArrayMethods = require('./methods');

var Document = require('../../document');

var arrayAtomicsSymbol = require('../../helpers/symbols').arrayAtomicsSymbol;

var arrayAtomicsBackupSymbol = require('../../helpers/symbols').arrayAtomicsBackupSymbol;
...
function MongooseDocumentArray(values, path, doc) {
  ...
  if (doc && doc instanceof Document) {
    ...
    internals[arraySchemaSymbol] = doc.$__schema.path(path); // `schema.path()` doesn't drill into nested arrays properly yet, see
