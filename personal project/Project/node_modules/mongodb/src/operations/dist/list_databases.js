...
/** @internal */
var ListDatabasesOperation = /** @class */ (function (_super) {
    __extends(ListDatabasesOperation, _super);
    ...
    Object.defineProperty(ListDatabasesOperation.prototype, "commandName", {
        get: function () {
    ...
    ListDatabasesOperation.prototype.execute = function (server, session) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (utils_1.maxWireVersion(server) >= 9 && this.options.comment !== undefined) {
