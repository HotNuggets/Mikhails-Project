...
function executeCommands(bulkOperation, options, callback) {
    ...
    var finalOptions = utils_1.resolveOptions(bulkOperation, __assign(__assign({}, options), { ordered: bulkOperation.isOrdered }));
    ...
    if (finalOptions.retryWrites) {
        if (isUpdateBatch(batch)) {
            finalOptions.retryWrites = finalOptions.retryWrites && !batch.operations.some(function (op) { return op.multi; });
        }
    ...
    try {
        var operation = isInsertBatch(batch)
            ...
            : isUpdateBatch(batch)
                ...
                : isDeleteBatch(batch)
                    ...
                    : null;
        if (operation != null) {
            execute_operation_1.executeOperation(bulkOperation.s.collection.client, operation).then(function (result) { return resultHandler(undefined, result); }, function (error) { return resultHandler(error); });
        }
    }
    catch (err) {
...
var executeCommandsAsync = util_1.promisify(executeCommands);
/**
 * TODO(NODE-4063)
...
var BulkOperationBase = /** @class */ (function () {
     ...
     * @internal
     */
    BulkOperationBase.prototype.handleWriteError = function (callback, writeResult) {
