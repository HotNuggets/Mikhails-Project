...
function (_MongooseError) {
  ...
  function ObjectParameterError(value, paramName, fnName) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ObjectParameterError).call(this, 'Parameter "' + paramName + '" to ' + fnName + '() must be an object, got "' + value.toString() + '" (type ' + _typeof(value) + ')'));
  }

  return ObjectParameterError;
}(MongooseError);
