...
function (_abstract_cursor_1$Ab) {
  ...
  function ListIndexesCursor(collection, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ListIndexesCursor).call(this, collection.client, collection.s.namespace, options));
      ...
      return regeneratorRuntime.async(function _initialize$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              operation = new indexes_1.ListIndexesOperation(this.parent, _objectSpread({}, this.cursorOptions, {}, this.options, {
                session: session
              }));
              _context.next = 3;
