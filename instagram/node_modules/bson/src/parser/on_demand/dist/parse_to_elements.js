...
exports.parseToElements = void 0;
...
function getSize(source, offset) {
    try {
        ...
        throw new error_1.BSONOffsetError('BSON size cannot be negative', offset, { cause: cause });
    }
}
/**
 ...
 * @experimental
 */
function parseToElements(bytes, startOffset) {
    if (startOffset === void 0) { startOffset = 0; }
    startOffset !== null && startOffset !== void 0 ? startOffset : ;
    0;
    if (bytes.length < 5) {
    ...
    while (offset <= documentSize + startOffset) {
        ...
        else if (type === 7 /* objectId */) {
            length = 12;
        }
        else if (type === 19 /* decimal */) {
            length = 16;
        }
        else if (type === 8 /* bool */) {
            length = 1;
        ...
        else if (type === 11 /* regex */) {
            length = findNull(bytes, findNull(bytes, offset) + 1) + 1 - offset;
        }
        else if (type === 3 /* object */ ||
            type === 4 /* array */ ||
            type === 15 /* javascriptWithScope */) {
