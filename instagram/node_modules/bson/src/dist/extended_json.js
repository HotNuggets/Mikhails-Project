...
function deserializeValue(value, options) {
    ...
    if (typeof value === 'number') {
        ...
        var in32BitRange = value <= constants_1.BSON_INT32_MAX && value >= constants_1.BSON_INT32_MIN;
        var in64BitRange = value <= constants_1.BSON_INT64_MAX && value >= constants_1.BSON_INT64_MIN;
...
function serializeValue(value, options) {
    if (value instanceof Map || utils_1.isMap(value)) {
        var obj = Object.create(null);
        for (var _i = 0, value_1 = value; _i < value_1.length; _i++) {
            var _a = value_1[_i], k = _a[0], v = _a[1];
            if (typeof k !== 'string') {
...
var BSON_TYPE_MAPPINGS = {
    ...
    BSONSymbol: function (o) { return new symbol_1.BSONSymbol(o.value); },
...
function serializeDocument(doc, options) {
    ...
    if (typeof bsontype === 'undefined') {
        ...
        doc[Symbol["for"]('@@mdb.bson.version')] !== constants_1.BSON_MAJOR_VERSION) {
