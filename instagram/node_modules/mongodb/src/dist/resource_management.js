...
exports.configureExplicitResourceManagement = exports.configureResourceManagement = void 0;
/** @internal */
            ...
            value: function asyncDispose() {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.asyncDispose()];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
function configureExplicitResourceManagement() {
    ...
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    var AbstractCursor = require('./cursor/abstract_cursor').AbstractCursor;
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    var ChangeStream = require('./change_stream').ChangeStream;
