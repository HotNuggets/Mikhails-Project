...
var isAsyncFunction = require('./helpers/isAsyncFunction');

var isSimpleValidator = require('./helpers/isSimpleValidator');
...
SchemaType.prototype.validate = function (obj, message, type) {
  ...
  for (i = 0, length = arguments.length; i < length; i++) {
    ...
    if (!utils.isPOJO(arg)) {
      var msg = 'Invalid validator. Received (' + _typeof(arg) + ') ' + arg + '. See https://mongoosejs.com/docs/api/schematype.html#SchemaType.prototype.validate()';
      throw new Error(msg);
    }
...
SchemaType.prototype.doValidate = function (value, fn, scope, options) {
  ...
  if (typeof fn !== 'function') {
    throw new TypeError("Must pass callback function to doValidate(), got ".concat(_typeof(fn)));
  ...
  var _loop2 = function _loop2(i, len) {
    ...
    var ok = void 0;
    var validatorProperties = isSimpleValidator(v) ? Object.assign({}, v) : clone(v);
    validatorProperties.path = options && options.path ? options.path : path;
    validatorProperties.fullPath = _this2.$fullPath;
  ...
  _loop: for (var i = 0, len = validators.length; i < len; ++i) {
