 ...
 * @public
 */
var MongoCredentials = /** @class */ (function () {
    function MongoCredentials(options) {
        ...
        if (this.mechanism.match(/MONGODB-AWS/i)) {
            ...
            if (this.mechanismProperties.AWS_SESSION_TOKEN == null &&
                ...
                this.mechanismProperties = __assign(__assign({}, this.mechanismProperties), { AWS_SESSION_TOKEN: process.env.AWS_SESSION_TOKEN });
            }
        }
        if (this.mechanism === providers_1.AuthMechanism.MONGODB_OIDC && !this.mechanismProperties.ALLOWED_HOSTS) {
            this.mechanismProperties = __assign(__assign({}, this.mechanismProperties), { ALLOWED_HOSTS: exports.DEFAULT_ALLOWED_HOSTS });
        }
        Object.freeze(this.mechanismProperties);
        Object.freeze(this);
    }
    /** Determines if two MongoCredentials objects are equivalent */
    MongoCredentials.prototype.equals = function (other) {
     ...
     */
    MongoCredentials.prototype.resolveAuthMechanism = function (hello) {
    ...
    MongoCredentials.prototype.validate = function () {
        var _a;
    ...
    MongoCredentials.merge = function (creds, options) {
