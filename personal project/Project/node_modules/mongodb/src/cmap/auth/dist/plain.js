...
var Plain = /** @class */ (function (_super) {
    ...
    Plain.prototype.auth = function (authContext) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        payload = new bson_1.Binary(Buffer.from("\0" + username + "\0" + password));
                        command = {
                            saslStart: 1,
                            mechanism: 'PLAIN',
                            payload: payload,
                        ...
                        return [4 /*yield*/, connection.command(utils_1.ns('$external.$cmd'), command, undefined)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
