 ...
 * @internal
 */
var TokenMachineWorkflow = /** @class */ (function (_super) {
    __extends(TokenMachineWorkflow, _super);
    /**
     ...
     */
    TokenMachineWorkflow.prototype.getToken = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs.promises.readFile(tokenFile, 'utf8')];
                    case 1:
                        token = _a.sent();
