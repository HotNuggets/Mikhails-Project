...
module.exports = function applyMethods(model, schema) {
  ...
  for (var _i = 0, _Object$keys = Object.keys(schema.methods); _i < _Object$keys.length; _i++) {
    ...
    if (schema.reserved[method] && !get(schema, "methodOptions.".concat(method, ".suppressWarning"), false)) {
      utils.warn("mongoose: the method name \"".concat(method, "\" is used by mongoose ") + 'internally, overwriting it may cause bugs. If you\'re sure you know ' + 'what you\'re doing, you can suppress this error by using ' + "`schema.method('".concat(method, "', fn, { suppressWarning: true })`."));
    }
