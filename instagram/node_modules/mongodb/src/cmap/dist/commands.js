...
var DocumentSequence = /** @class */ (function () {
    function DocumentSequence(documents) {
    ...
    OpMsgRequest.prototype.extractDocumentSequences = function (document) {
        ...
        for (var _i = 0, _a = Object.entries(document); _i < _a.length; _i++) {
            ...
            if (value instanceof DocumentSequence) {
                ...
                var buffer = Buffer.allocUnsafe(1 + 4 + key.length);
                buffer[0] = 1;
                ...
                var docsLength = 0;
                for (var _c = 0, _d = value.documents; _c < _d.length; _c++) {
                    var doc = _d[_c];
                    var docBson = this.serializeBson(doc);
